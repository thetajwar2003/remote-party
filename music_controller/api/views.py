...
class JoinRoom(APIView):
    ...
    def post(self, request, format=None):
        ...
        return Response({'Bad Request: Did not recieve code key'}, status=status.HTTP_404_NOT_FOUND)
...
class UserInRoom(APIView):
    def get(self, request, format=None):
        ...
        return JsonResponse(data, status=status.HTTP_200_OK) # serialize python dict and sents to front end
...
class UpdateRoom(APIView):
    serializer_classs = UpdateRoomSerializer
